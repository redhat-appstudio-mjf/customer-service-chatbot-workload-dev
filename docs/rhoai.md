...
2) Go to the `Data Science Projects` section and access your application's project named `customer-service-chatbot-workload-dev`.

![image](./images/data-science-projects.png)

3) Access the `workbench` named `customer-service-chatbot-workload-dev-notebook`.
...
5) In the terminal, run `cd customer-service-chatbot-workload-dev` to navigate to your sample app's directory.
